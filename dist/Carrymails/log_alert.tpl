...
@media only screen and (max-width: 300px){
    ...
    table.table-list tr td:last-child{text-align: center !important;}
      ...
      >${{ lang.you_have_received_a_new_log_alert }}$</div>
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000;"
      >${{ lang.warning_you_have_received_a_new_log_alert_in_your_back_office }}$</div>
    ...
    <![endif]-->
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000;"
      >${{ lang.you_can_check_for_it_in_the_tools__logs_section_of_your_back_office }}$</div>
