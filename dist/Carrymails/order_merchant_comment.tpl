...
@media only screen and (max-width: 300px){
    ...
    table.table-list tr td:last-child{text-align: center !important;}
      ...
      >${{ lang.message_from_shop_name }}$</div>
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000;"
      >${{ lang.you_have_received_a_new_message_from_shop_name_regarding_order_with_the_reference_order_name }}$</div>
    ...
    <!-- mj-include fails to read file : ./src/partials/footer.mjml at /Users/jakubsmac/Desktop/presta mails/src/src/partials/footer.mjml -->
      </div>
