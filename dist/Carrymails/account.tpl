...
@media only screen and (max-width: 300px){
    ...
    <!-- Header with message -->
      ...
      >${{ lang.your_shop_name_login_details }}$</div>
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000;"
      >${{ lang.here_are_your_login_details }}$</div>
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;font-weight:bold;line-height:1;text-align:left;color:#000000;"
      >${{ lang.email_address }}$ {email}</div>
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000;"
      >${{ lang.important_security_tips }}$</div>
      ...
      <![endif]-->
            ...
            <tr>
              <td
                 align="left" style="font-size:0px;padding:2px 15px 2px 5px;word-break:break-word;"
              >
                
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:20px;text-align:left;color:#000000;"
      ><ol>
                            <li>${{ lang.always_keep_your_account_details_safe }}$</li>
                            <li>${{ lang.never_disclose_your_login_details_to_anyone }}$</li>
                            <li>${{ lang.change_your_password_regularly }}$</li>
                            <li>${{ lang.should_you_suspect_someone_is_using_your_account_illegally_please_notify_us_immediately }}$</li>
                        </ol></div>
