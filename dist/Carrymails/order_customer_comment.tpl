...
@media only screen and (max-width: 300px){
    ...
    table.table-list tr td:last-child{text-align: center !important;}
      ...
      >${{ lang.message_from_a_customer }}$</div>
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000;"
      >${{ lang.you_have_received_a_new_message_regarding_order_with_the_reference }}$ {order_name}</div>
    ...
    <![endif]-->
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000;"
      ><strong>${{ lang.customer }}$</strong> {firstname} {lastname} ({email})</div>
