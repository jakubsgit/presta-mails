...
@media only screen and (max-width: 300px){
    ...
    table.table-list tr td:last-child{text-align: center !important;}
      ...
      >${{ lang.customer_service__forwarded_discussion }}$</div>
      ...
      >${{ lang.employee_wanted_to_forward_this_discussion_to_you }}$</div>
      ...
      >${{ lang.discussion_history }}$</b></div>
            ...
            <tr>
              <td
                 align="center" style="font-size:0px;padding:2px 15px 20px;word-break:break-word;"
              >
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:center;color:#000000;"
      >${{ lang.employee_added_comment }}$</div>
