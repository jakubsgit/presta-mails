...
@media only screen and (max-width: 300px){
    ...
    table.table-list tr td:last-child{text-align: center !important;}
      ...
      >${{ lang.order_order_name }}$ - ${{ lang.in_transit }}$</div>
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000;"
      >${{ lang.your_order_with_the_reference_order_name_is_currently_in_transit }}$</div>
    ...
    <![endif]-->
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000;"
      >${{ lang.you_can_track_your_package_using_the_following_link }}$</div>
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000;"
      ><a href="${{ lang.followup }}$" target="_blank">${{ lang.followup }}$</a></div>
    ...
    <!-- mj-include fails to read file : ./src/partials/account.mjml at /Users/jakubsmac/Desktop/presta mails/src/src/partials/account.mjml -->
      </div>
