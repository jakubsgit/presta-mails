...
@media only screen and (max-width: 300px){
    ...
    table.table-list tr td:last-child{text-align: center !important;}
      ...
      >${{ lang.order_order_name }}$ - ${{ lang.payment_processed }}$</div>
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:center;color:#000000;"
      >${{ lang.your_payment_for_order_with_the_reference_order_name_was_successfully_processed }}$</div>
    ...
    <![endif]-->
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:center;color:#000000;"
      >${{ lang.thank_you_for_shopping_with_shop_name }}$</div>
