...
.mj-column-per-14 { width:14% !important; max-width: 14%; }
...
.title-divider-hero{border-color: #445566 !important}
...
@media only screen and (max-width: 300px){
    ...
    table.table-list tr td:last-child{text-align: center !important;}
      ...
      <img
         height="auto" src="https://carry.pl/img/theme/mails/carry-logo.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="300"
      />
    ...
    <!-- Header with message -->
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:25px;line-height:1;text-align:center;color:#000000;"
      >Dziękujemy za złożenie zamówienia w sklepie <strong>{shop_name}<strong></div>
      ...
      <table
         border="0" cellpadding="0" cellspacing="0" role="presentation" style="background-color:#fbfbfb;vertical-align:top;" width="100%"
      >
      ...
      ><strong>${{ lang.order }}$</strong> {order_name} ${{ lang.placed_on }}$ {date}</div>
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000;"
      ><strong>${{ lang.payment }}$</strong> {payment}</div>
    ...
    <!-- End of Header -->
      ...
      >
        <tr>
                <th style="border:2px solid #445566;padding: 10px;">Numer produktu</th>
                <th style="border:2px solid #445566;padding: 10px;">Produkt</th>
                <th style="border:2px solid #445566;padding: 10px;">Cena jednostkowa</th>
                <th style="border:2px solid #445566;padding: 10px;">Ilość</th>
                <th style="border:2px solid #445566;padding: 10px;">Cena całkowita</th>
            </tr>
            <tr>
                <td colspan="5" style="border:1px solid #D6D4D4; border-bottom: none; padding:7px 7px 0 7px;" align="center">
                    <table width="100%" cellspacing="0" cellpadding="0" border="0" class="table-list" background-color="#fbfbfb">
                        {products}
                    </table>
                </td>
            </tr>
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:left;color:#000000;"
      ><strong>${{ lang.carrier }}$</strong> {carrier}</div>
      ...
      <div  style="background:#fbfbfb;background-color:#fbfbfb;Margin:0px auto;max-width:600px;">
        ...
        <tr>
            ...
            <td
               class="" style="vertical-align:top;width:288px;"
            >
          <![endif]-->
            
      <div
         class="mj-column-per-48 outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;"
      >
      ...
      <!--[if mso | IE]>
        <table
           align="center" border="0" cellpadding="0" cellspacing="0" style="border-top:solid 4px #445566;font-size:1;margin:0px auto;width:238px;" role="presentation" width="238px"
        >
          <tr>
            <td style="height:0;line-height:0;">
              &nbsp;
      ...
      >{delivery_block_html}</div>
          ...
          <!--[if mso | IE]>
            ...
            <td
               class="" style="vertical-align:top;width:24px;"
            >
          <![endif]-->
            
      <div
         class="mj-column-per-4 outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;"
      >
    ...
    <![endif]-->
      ...
      >
        <tr>
          <td
             align="center" bgcolor="#414141" role="presentation" style="border:none;border-radius:10px;cursor:auto;mso-padding-alt:10px 25px;background:#414141;" valign="middle"
          >
            <a
               href="{shop_url}my-account.php" style="display:inline-block;background:#414141;color:#ffffff;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:10px;" target="_blank"
            >
              <span style="letter-spacing: 2px;" color="white">Sprawdź swoje zamówienie</span>
            </a>
          </td>
        </tr>
      </table>
      ...
      >tylko dla zalogowanych użytkowników</div>
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:23px;font-weight:bold;line-height:1;text-align:center;text-transform:uppercase;color:#445566;"
      >Szukasz inspiracji? Obserwuj nas!</div>
      ...
      >
            ...
            <tr>
              <td
                 align="center" style="font-size:0px;padding:6px 6px;word-break:break-word;"
              >
    ...
    <!-- Social -->
      ...
      <div  style="background:#fbfbfb;background-color:#fbfbfb;Margin:0px auto;max-width:600px;">
        ...
        <tr>
            ...
            <td
               class="" style="vertical-align:top;width:84px;"
            >
          <![endif]-->
            
      <div
         class="mj-column-per-14 outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;"
      >
      ...
      >
        ...
        <a
           href="www.facebook.com/carryworld" target="_blank"
        >
          
      <img
         alt="carry facebook" height="auto" src="https://static.cdn.responsys.net/i2/responsysimages/uggs/contentlibrary/promotional/2017/06-june/20170615_u_royale-b/images/share-facebook.gif" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="34"
      />
      ...
      <div
         class="mj-column-per-36 outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;"
      >
      ...
      ><a href="www.instagram.com/carrypolska" target="_blank"  text-decoration="none">instagram.com<br/>carrypolska</a></div>
      ...
      >
        ...
        <a
           href="http://www.ugg.com/" target="_blank"
        >
          
      <img
         alt="ugg instagram" height="auto" src="https://static.cdn.responsys.net/i2/responsysimages/uggs/contentlibrary/promotional/2017/06-june/20170615_u_royale-b/images/share-instagram.gif" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="34"
      />
    ...
    <!-- Footer-footer -->
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:16px;text-align:center;color:#445566;"
      >Możesz sprawdzić swoje zamówienie i wydrukować potwierdzenie z <a href="{history_url}" style="color:#337ff1">Historia zamówień</a>, lub wejść na swoje konto<a href="{my_account_url}" style="color:#337ff1"> Moje konto</a> na naszym sklepie</span></div>
      ...
      <div
         style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:16px;text-align:center;color:#445566;"
      >Ten e-mail został wygenerowany automatycznie. Proszę na niego nie odpowiadać.</div>
